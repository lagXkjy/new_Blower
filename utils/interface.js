...
// const domain = `https://test.1-zhao.fun` //测试域名
const phoneReg = /^(1[3456789]|9[28])\d{9}$/ // 正则手机号码
const uploadUrl = `${domain}/Images/` //上传图片的地址
const BlowerExce = `${domain}/BlowerExcel/` //下载文件地址
module.exports = {
  phoneReg,
  uploadUrl,
  BlowerExce,
  ...
  //下载
  GetExcelFileStr: `${domain}/LittleProgram/Blower/GetExcelFileStr`,
  //是否绑定手机号
  GetIsRegister : `${domain}/LittleProgram/Blower/GetIsRegister`,
}